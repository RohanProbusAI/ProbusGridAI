...
def parse_converted_json(json_path_or_data, original_excel_path=None, user_company=None, skip_prompts=False, manual_segment=None):
    """
    ...
    if "sheets" in data:
        ...
        for sheet_name, sheet_data in data["sheets"].items():
            ...
            if has_segment_column:
                ...
                # )
                if skip_prompts and manual_segment:
